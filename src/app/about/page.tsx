      ...
      <main className="container-max py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10">
          <div className="glass rounded-2xl p-6">
            ...
            <p className="text-white/70 mt-2">Apex, Lightning, and platform architecture tailored to your business.</p>
          </div>
          <div className="glass rounded-2xl p-6">
            <h3 className="font-semibold">AWS at Scale</h3>
            <p className="text-white/70 mt-2">Secure, scalable cloud solutions using S3, Lambda, EC2, and more.</p>
          </div>
          <div className="glass rounded-2xl p-6">
            <h3 className="font-semibold">AI Automation</h3>
            <p className="text-white/70 mt-2">Intelligent workflows that reduce manual work and speed up delivery.</p>
          </div>
        </div>
      </main>
      <Footer />
